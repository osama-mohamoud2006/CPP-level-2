...
int main()
{
    ...
    // you cann't use string data type with printf
    // c ->> string is array of chars
    // c++ -->> string is object
    printf("%s", "sfdsf"); // output is garabge

    char name[] = {"osama"}; // array of chars
    printf("\nmy name is: %s", name);

    string details = "hello my friend it is me!";
    // method to use printf with string directly
